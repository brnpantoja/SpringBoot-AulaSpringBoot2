...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<BadRequestExceptionDetails> handleBadRequestExcepition(BadRequestException bre) {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(
        ...
        ExceptionDetails exceptionalDetails = ExceptionDetails.builder()
                .timestamp(LocalDateTime.now())
                .status(status.value())
